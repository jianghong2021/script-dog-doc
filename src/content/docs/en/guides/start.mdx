...
2. #### Fill in Project Information
    ...
    - **Dependencies**  
        - **Scenario** - When you need to use third-party libraries, fill in here. Multiple libraries should be separated by line breaks.  
        - **Programming Requirement** - Applicable to both text and visual programming.  
        - **Example** - ``` https://cdn.xx.com/v102/xx.js``` After filling in, refer to the *Programming* section for usage instructions.  

    - **Resource References**  
        - **Scenario** - When you need to use additional resources (images, CSS styles, etc.), fill in here. Multiple resources should be separated by line breaks.  
        - **Programming Requirement** - Applicable to both text and visual programming.  
        - **Example** - ```xx_image https://cdn.xx.com/static/xx.png``` <Badge text='Note' variant='caution'/>: **You must add a reference name before each link, followed by a space, to enable referencing in the project later**. After filling in, refer to the *Programming* section for usage instructions.  
